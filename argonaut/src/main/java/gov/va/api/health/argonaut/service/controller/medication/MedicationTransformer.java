...
public class MedicationTransformer implements MedicationController.Transformer {
  ...
  @Override
  public Medication apply(CdwMedication101Root.Medications.Medication medication) {
    return medication(medication);
  }

  CodeableConcept code(gov.va.dvp.cdw.xsd.model.CodeableConcept code) {
    if (code == null) {
      return null;
    }
  ...
  private List<Coding> coding(List<gov.va.dvp.cdw.xsd.model.Coding> coding) {
    if (coding == null) {
      return null;
    }
    LinkedList<Coding> argoCodings = new LinkedList<>();
    for (gov.va.dvp.cdw.xsd.model.Coding argoCoding : coding) {
      argoCodings.add(
          Coding.builder()
  ...
  private Medication medication(CdwMedication101Root.Medications.Medication medication) {
  ...
  Product product(CdwMedication101Root.Medications.Medication.Product product) {
    if (product == null) {
      return null;
    }
  ...
  CodeableConcept productForm(gov.va.dvp.cdw.xsd.model.CodeableConcept productForm) {
    // return null;
