...
public class DiagnosticReportTest {
  ...
  public void validationPassesGivenGoodCategory() {
      assertThat(violationsOf(diagnosticReportsData.diagnosticReport().category().coding().get(0).code("http://hl7.org/fhir/ValueSet/diagnostic-service-sections"))).isEmpty();
  }
