...
public class Dstu2DiagnosticReportControllerTest {
  ...
  public void searchById() {
    ...
    assertThat(Iterables.getOnlyElement(bundle.entry()).resource()).isEqualTo(Dstu2.create().report());
    assertThat(json(bundle)).isEqualTo(json(Dstu2.asBundle(
            "http://fonzy.com/cool",
            List.of(Dstu2.create().report()),
            link(
                    BundleLink.LinkRelation.first, "http://fonzy.com/cool/DiagnosticReport?identifier=800260864479:L", 1, 15),
            link(
                    BundleLink.LinkRelation.self, "http://fonzy.com/cool/DiagnosticReport?identifier=800260864479:L", 1, 15),
            link(
                    BundleLink.LinkRelation.last, "http://fonzy.com/cool/DiagnosticReport?identifier=800260864479:L", 1, 15))));
  }
  ...
  public void searchByPatient() {
    ...
    assertThat(json(bundle)).isEqualTo(json(Dstu2.asBundle(
            ...
            List.of(Dstu2.create().report()),
            link(
                    BundleLink.LinkRelation.first, "http://fonzy.com/cool/DiagnosticReport?patient=1011537977V693883", 1, 15),
            link(
                    BundleLink.LinkRelation.self, "http://fonzy.com/cool/DiagnosticReport?patient=1011537977V693883", 1, 15),
            link(
                    BundleLink.LinkRelation.last, "http://fonzy.com/cool/DiagnosticReport?patient=1011537977V693883", 1, 15))));
  }
  ...
  public void searchByPatientAndCodeWithNoCodeGiven() {
    ...
    entityManager.persistAndFlush(dm.entity());
    entityManager.persistAndFlush(dm.crossEntity());
    DiagnosticReport.Bundle bundle = controller().searchByPatientAndCode("1011537977V693883", "", 1, 15);
    assertThat(Iterables.getOnlyElement(bundle.entry()).resource()).isEqualTo(Dstu2.create().report());
    assertThat(json(bundle)).isEqualTo(json(Dstu2.asBundle(
            "http://fonzy.com/cool",
            List.of(Dstu2.create().report()),
            link(
                    BundleLink.LinkRelation.first, "http://fonzy.com/cool/DiagnosticReport?code=&patient=1011537977V693883", 1, 15),
            link(
                    BundleLink.LinkRelation.self, "http://fonzy.com/cool/DiagnosticReport?code=&patient=1011537977V693883", 1, 15),
            link(
                    BundleLink.LinkRelation.last, "http://fonzy.com/cool/DiagnosticReport?code=&patient=1011537977V693883", 1, 15))));
  }
  ...
  public void searchByPatientAndCodeWithCodeGivenShouldGiveNoResults() {
    ...
    entityManager.persistAndFlush(dm.entity());
    entityManager.persistAndFlush(dm.crossEntity());
    DiagnosticReport.Bundle bundle = controller().searchByPatientAndCode("1011537977V693883", "x", 1, 15);
  ...
  public void searchByPatientAndCategoryAndDateForDateWithNoResults() {
    ...
    DiagnosticReport.Bundle bundle =
            controller()
                    .searchByPatientAndCategoryAndDate("1011537977V693883", "LAB", new String[] {"ge2000"}, 1, 15);
    assertThat(bundle.entry()).isEmpty();
  }
  ...
  public void searchByPatientAndCategoryAndDateForCategoryWithNoResults() {
    ...
    entityManager.persistAndFlush(dm.crossEntity());
    DiagnosticReport.Bundle bundle =
            controller().searchByPatientAndCategoryAndDate("1011537977V693883", "CHEM", new String[] {}, 1, 15);
