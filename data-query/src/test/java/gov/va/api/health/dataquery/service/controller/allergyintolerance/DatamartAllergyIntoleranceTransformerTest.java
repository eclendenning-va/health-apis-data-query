...
public class DatamartAllergyIntoleranceTransformerTest {
  ...
  public void manifestations() {
    ...
    assertThat(tx().manifestations(Datamart.create().manifestations()))
        .isEqualTo(Fhir.create().manifestations());
  }
  ...
  public void notes() {
    ...
    assertThat(tx().notes(Datamart.create().notes())).isEqualTo(Fhir.create().note());
  }
  ...
  public void reactions() {
    ...
    assertThat(tx().reactions(Datamart.create().reactions())).isEqualTo(Fhir.create().reactions());
  }
  ...
  public void substance() {
    ...
    assertThat(tx().substance(Datamart.create().fullyPopulatedSubstance()))
        .isEqualTo(Fhir.create().fullyPopulatedSubstance());
  }

  @Test
  public void toFhir() {
    assertThat(tx().toFhir()).isEqualTo(Fhir.create().allergyIntolerance());
  }

  private DatamartAllergyIntoleranceTransformer tx() {
    return DatamartAllergyIntoleranceTransformer.builder()
        .datamart(DatamartAllergyIntoleranceSamples.Datamart.create().allergyIntolerance())
        .build();
  }
